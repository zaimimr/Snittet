"use client"
export default function SnackbarActionButton({ action }: { action: () => void }) {
    return (
        <button onClick={() => action()} type="button" className="ml-auto -my-1.5 stroke-white border-white border-2 hover:stroke-gray-900 rounded-lg  p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 " data-dismiss-target="#toast" aria-label="Close">
