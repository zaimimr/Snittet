...
export default c.define('/src/content/pages/index', schema, {
  ...
  description: `Etter at NTNU kuttet støtte for å hente fag fra deres APIer har snitt.zaim.no endret datakilde og støtter nå alle universiteter og høyskoler. Spread the word, den beste snittkalkulatoren er endelig her, klar for å hjelpe deg akkuratt deg 🎓`
});
